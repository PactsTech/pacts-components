...
import type { JSX } from '@pactstech/stencil-components';



export const ArbitrumSvg = /*@__PURE__*/createReactComponent<JSX.ArbitrumSvg, HTMLArbitrumSvgElement>('arbitrum-svg');
export const AvalancheSvg = /*@__PURE__*/createReactComponent<JSX.AvalancheSvg, HTMLAvalancheSvgElement>('avalanche-svg');
export const BaseSvg = /*@__PURE__*/createReactComponent<JSX.BaseSvg, HTMLBaseSvgElement>('base-svg');
export const BscSvg = /*@__PURE__*/createReactComponent<JSX.BscSvg, HTMLBscSvgElement>('bsc-svg');
...
export const PolygonSvg = /*@__PURE__*/createReactComponent<JSX.PolygonSvg, HTMLPolygonSvgElement>('polygon-svg');
