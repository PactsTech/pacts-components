          ...
          <g id='prefix__Layer_1-2' data-name='Layer 1'>
            <g id='prefix__Page-1'>
              <g id='prefix__wbtc_colour' data-name='wbtc colour'>
                ...
                <path
                  id='prefix__Shape-6'
                  d='M54.62 109.26a54.63 54.63 0 1 1 54.64-54.64 54.63 54.63 0 0 1-54.64 54.64m0-105A50.34 50.34 0 1 0 105 54.62 50.34 50.34 0 0 0 54.62 4.26'
                  data-name='Shape'
                  style={{
                    fill: '#282138',
                  }}
